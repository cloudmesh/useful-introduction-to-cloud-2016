...
.. figure:: ../../images/cloud_register_ec2.png
   :width: 80%
   :align: center

   **Figure:** Registering an EC2 compatible cloud

.. figure:: ../../images/cloud_register_openstack.png
   :width: 80%
   :align: center   
   
   **Figure:** Registering an OpenStack protocol compatible cloud. 

.. figure:: ../../images/manage_vms.png
   :width: 80%
   :align: center   
...
.. figure:: ../../images/launcher.png
   ...
   **Figure:** Launching predefined configurations on FutureSystems

.. figure:: ../../images/provisioning_policy.png
   :width: 80%
   :align: center
...
possible to start Hadoop jobs in queues on FutureSystems.

.. figure:: ../../images/qinfo.png
   :width: 80%
   :align: center
      
   **Figure:** Listing the available queues

.. figure:: ../../images/qstat.png
   :width: 80%
   :align: center
...
FutureSystems this system is already deployed via the FG portal.

.. figure:: ../../images/status_hpc.png
   :width: 80%
   :align: center   
