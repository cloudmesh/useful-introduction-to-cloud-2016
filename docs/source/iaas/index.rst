...
includess compute, storage and network components allowing users to
get easily stated in cloud computing.

Many clouds exist that have OpenStack as a foundation as part of the
cloudservices offered to users. Some of them are free, some are
commercial services.
